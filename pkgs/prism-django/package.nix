...
let
  ...
  src = builtins.fetchGit {
    url = "ssh://git@github.com/Outback-Steakhouse-Of-Pancakes/prism-django.git";
    #ref = "main";
    rev = "b01a9edc7e28ae7803a01a30e8f08dde68d6a90f"; # pin to specific commit for reproducibility
